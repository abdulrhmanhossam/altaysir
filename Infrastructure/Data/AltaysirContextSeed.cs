...
public class AltaysirContextSeed
{
    public static async Task SeedAsync(AltaysirContext context, ILoggerFactory loggerFactory)
    {
        try
        {
        ...
        {
            var logger = loggerFactory.CreateLogger<AltaysirContextSeed>();
